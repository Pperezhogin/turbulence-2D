...
//spectrum parameters
const Real CFL = (Real) 0.2 / (coarse_coef); //CFL = 1 is a maximum
Real dt;
...
// ------ SGS KE params ------- //
int nu2_method = nu2_est_pm;
int initial_cond = set_SFS_energy;
...
#ifdef DECAYING_TURBULENCE
	#ifdef START_TIME_1
	read_binary_przgn("/data90t/users/perezhogin/decaying-turbulence/initial_conditions_time_1/res_128_filter_128/psi-.nsx", Psisol, grid, file_index);
	#else
